...
Michelson second experiment coincides with Newcomb measurements, while Michelson's first experiment (light1) differs from them others.  
...
In order to test wether the median is 32 or less, we will firstly test if it's equal to 32, and if it is rejected check lower values to see if it can have a lower median.
