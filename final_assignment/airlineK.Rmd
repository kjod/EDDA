...
The research question is does the prior number of casualties of an airplane mean that this airplane is more likely to crash in the future. From this one question many subquestions will arise such as has air travel become safer with time, how the amount of causalities are affected by the location of crashes, manufacturers and the year of teh crash

\section{Preliminary tests}

Firstly, some preliminary tests are conducted on ethe first dataset. This is a good dataset to do so, as it is really general and it stores information on big periods. It includes the amount of aircrashes per airline in two periods. The first period is from 1985 to 1999, and the second period from 2000 to 2014.
