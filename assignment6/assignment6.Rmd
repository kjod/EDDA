...
In this boxplot of average gpa based on whether the student was instructed using psi or not, it can be seen that the ones with psi have a slightly better gpa, although the plot also shows the existence of some outliers.
