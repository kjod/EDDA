...
```
The alnova ANOVA produce significantly different results than the Kruskal-Wallis. The qqnorm of the residuals deviates from the normal distrubution. This woukd account for the signifant difference in the results so in this case it would be better to use Kruskal-Wallis.
